...
public class EmpSearchController2 extends AbstractController {
	...
	public String doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try {
			...
			String hire_date =  request.getParameter("hire_date"); //2000-02-01
			String hiredateCompare = request.getParameter("hiredateCompare");
			
			//hire_date(문자열)이 아닌 Date차입으로 처리
			Date hireDate = null;
			...
			//param.put("hire_date", hire_date); //문자형
			param.put("hireDate", hireDate);//날짜형
